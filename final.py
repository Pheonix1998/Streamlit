...
def get_connection():
    """
    Establish and return SQL Server connection.
    """
...
status_filter = st.sidebar.multiselect(
    "Booking Status", df["Booking_Status"].unique(), df["Booking_Status"].unique()
)
vehicle_filter = st.sidebar.multiselect(
    "Vehicle Type", df["Vehicle_Type"].unique(), df["Vehicle_Type"].unique()
)
payment_filter = st.sidebar.multiselect(
    "Payment Method", df["Payment_Method"].unique(), df["Payment_Method"].unique()
)
